...
-->>
				...
				<a-menu-item>
					<router-link to="/switchDevices">
						<span class="label">Switch Devices</span>
					</router-link>
				</a-menu-item>
				...
				<a-menu-item>
					<router-link to="/generatorUnits">
						<span class="label">Generator Units</span>
					</router-link>
				</a-menu-item>
				...
				<a-menu-item>
					<router-link to="/capacitySensors">
						<span class="label">Capacity Sensors</span>
					</router-link>
				</a-menu-item>

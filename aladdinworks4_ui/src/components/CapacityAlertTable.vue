...
<template>
  ...
  <base-input label="ExceededCapacity" type="text" placeholder="Enter ExceededCapacity" v-model="capacityAlertToAdd.exceededCapacity"></base-input>
                  </form>
                </div>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {
          title: 'Exceeded Capacity',
		dataIndex: 'exceededCapacity',
          visible: true,
          scopedSlots: { customRender: 'exceededCapacity' },
          sorter: true
          //sorter: (a, b) => a.exceededCapacity - b.exceededCapacity,
          //sorter: (a, b) => a.exceededCapacity.localeCompare(b.exceededCapacity),
        },
      ],
      pagination: {
        current: 1,
